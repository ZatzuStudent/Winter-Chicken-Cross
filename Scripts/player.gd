...
const PLAYER_START_POSITION = Vector2(0, 352)
const POSITION_INCREMENT = 54


@onready var death_texture = preload("res://Assets/Ghost 1.png")
@onready var idle_texture = preload("res://Assets/Chicken 1.png")
